...
<div class="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4">
    <div class="text-center max-w-lg">
        ...
        <div class="space-y-4">
            ...
            <a href="javascript:history.back()" class="block border-2 border-blue-600 text-blue-600 px-8 py-4   font-bold text-lg hover:bg-blue-50 transition duration-300">
