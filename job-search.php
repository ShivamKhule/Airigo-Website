                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div>
                        <select name="category" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                            ...
                            <option value="Aviation" <?= $category === 'Aviation' ? 'selected' : '' ?>>Aviation</option>
                            <option value="Hospitality" <?= $category === 'Hospitality' ? 'selected' : '' ?>>Hospitality</option>
                            <option value="Travel & Tourism" <?= $category === 'Travel & Tourism' ? 'selected' : '' ?>>Travel & Tourism</option>
                        </select>
                    </div>
                    <div>
                        <button type="submit" class="w-full bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 transition duration-300 font-semibold">
                    ...
                    <form method="GET">
                        ...
                        <div class="mb-6">
                            ...
                            <div class="space-y-2">
                                ...
                                <label class="flex items-center">
                                    <input type="radio" name="category" value="Aviation" <?= $category === 'Aviation' ? 'checked' : '' ?> class="mr-2">
                                ...
                                <label class="flex items-center">
                                    <input type="radio" name="category" value="Travel & Tourism" <?= $category === 'Travel & Tourism' ? 'checked' : '' ?> class="mr-2">
                                    <span class="text-sm">Travel & Tourism</span>
                                </label>
                            </div>
                        </div>
                        
                        <button type="submit" class="w-full bg-gray-800 text-white px-4 py-2 rounded-lg hover:bg-gray-900 transition duration-300">
                            Apply Filters
                        </button>
                    </form>
                </div>
                ...
                <div class="mb-6">
                    <h2 class="text-xl font-semibold text-gray-800">
                        ...
                        <?php if ($keyword || $location || $category): ?>
                            for "<?= htmlspecialchars($keyword ?: $location ?: $category) ?>"
                        <?php endif; ?>
                    </h2>
                </div>
                ...
                <div class="space-y-6">
                    <?php if (empty($jobs)): ?>
                        <div class="bg-white rounded-lg shadow-md p-8 text-center">
                            ...
                            <a href="job-search.php" class="inline-block mt-4 bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 transition duration-300">
                                View All Jobs
                            </a>
                        </div>
                    <?php else: ?>
                        <?php foreach ($jobs as $job): ?>
                            <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition duration-300 p-6">
                                ...
                                <p class="text-gray-600 mb-4 line-clamp-2"><?= htmlspecialchars(substr($job['description'], 0, 150)) ?>...</p>
