...
echo "<script>console.log('$job');</script>";
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2">
                ...
                <div class="bg-white rounded-lg shadow-md p-6 mb-6">
                        ...
                        <div>
                            ...
                            <div class="flex flex-wrap gap-4 text-sm text-gray-600">
                                <?php if (!empty($job['location'])): ?>
                                    <span><i
                                            class="fas fa-map-marker-alt mr-1"></i><?= htmlspecialchars($job['location']) ?></span>
                                <?php endif; ?>
                                ...
                                <?php if (!empty($job['ctc'])): ?>
                                    <span><i
                                            class="fas fa-money-bill-wave mr-1"></i><?= htmlspecialchars($job['ctc']) ?></span>
                                <?php endif; ?>
                            </div>
                        </div>
                    ...
                    <div class="mt-4 text-sm text-gray-500">
                        ...
                        <?php
                        echo "<script>console.log('$job.createdAt');</script>";
                        echo "<script>console.log('$job.requirements');</script>";
                        ?>

                    </div>
                    <span class="text-gray-400 text-3xl"><?= htmlspecialchars($job['createdAt']) ?></span>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    <div class="flex items-center gap-4">
                        <?php if (!empty($job['imageUrl'])): ?>
                            <img src="<?= htmlspecialchars($job['imageUrl']) ?>" class="w-16 h-16 rounded-lg object-cover"
                                alt="<?= htmlspecialchars($job['companyName']) ?>">
                        <?php endif; ?>

                        <div>
                            <p class="font-semibold text-gray-800"><?= htmlspecialchars($job['companyName']) ?></p>
                            <p class="text-sm text-gray-600"><?= htmlspecialchars($job['location']) ?></p>
                        </div>
                    </div>
                </div>
            ...
            <div>
                ...
                <div class="bg-white rounded-lg shadow-md p-6 sticky top-6">
                    ...
                    <button class="w-full bg-blue-600 text-white py-3 rounded-lg font-semibold mb-3">
                        Apply Now
                    </button>
