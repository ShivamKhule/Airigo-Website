        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div class="lg:col-span-1">
                <div class="bg-white rounded-xl shadow-lg p-6 sticky top-8">
                    ...
                    <div class="mb-8">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="w-full bg-gray-200 rounded-full h-2">
                                <div class="bg-blue-600 h-2 rounded-full" style="width: <?php echo $userData['profile_complete_percentage'] ?? 60; ?>%"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Navigation -->
                    <nav class="space-y-2">
                        <a href="#personal" class="block px-4 py-3 rounded-lg bg-blue-50 text-blue-600 font-medium">
                            <i class="fas fa-user mr-2"></i>Personal Information
                        </a>
                        <?php if ($userRole === 'jobseeker'): ?>
                        <a href="#professional" class="block px-4 py-3 rounded-lg text-gray-700 hover:bg-gray-100 font-medium">
                            <i class="fas fa-briefcase mr-2"></i>Professional Info
                        </a>
                        <a href="#education" class="block px-4 py-3 rounded-lg text-gray-700 hover:bg-gray-100 font-medium">
                            <i class="fas fa-graduation-cap mr-2"></i>Education
                        </a>
                        <a href="#skills" class="block px-4 py-3 rounded-lg text-gray-700 hover:bg-gray-100 font-medium">
                            <i class="fas fa-star mr-2"></i>Skills
                        </a>
                        <a href="#preferences" class="block px-4 py-3 rounded-lg text-gray-700 hover:bg-gray-100 font-medium">
                            <i class="fas fa-sliders-h mr-2"></i>Job Preferences
                        </a>
                        <?php else: ?>
                        <a href="#company" class="block px-4 py-3 rounded-lg text-gray-700 hover:bg-gray-100 font-medium">
                            <i class="fas fa-building mr-2"></i>Company Information
                        </a>
                        <?php endif; ?>
                        <a href="#resume" class="block px-4 py-3 rounded-lg text-gray-700 hover:bg-gray-100 font-medium">
                            <i class="fas fa-file-alt mr-2"></i>Resume/CV
                        </a>
                        <a href="#security" class="block px-4 py-3 rounded-lg text-gray-700 hover:bg-gray-100 font-medium">
            ...
            <div class="lg:col-span-3">
                <form method="POST" action="" class="space-y-8">
                    ...
                    <div id="personal" class="bg-white rounded-xl shadow-lg p-8">
                        ...
                        <div class="mt-8 pt-8 border-t">
                            ...
                            <div class="flex items-center">
                                <div class="w-32 h-32 bg-blue-100 rounded-full flex items-center justify-center mr-6">
                                ...
                                <div>
                                    ...
                                    <div class="flex space-x-3">
                                        <label class="cursor-pointer bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 font-medium">
                    ...
                    <div id="professional" class="bg-white rounded-xl shadow-lg p-8">
                        <div class="flex items-center justify-between mb-6">
                    ...
                    <!-- Education -->
                    <div id="education" class="bg-white rounded-xl shadow-lg p-8">
                        <div class="flex items-center justify-between mb-6">
                    ...
                    <!-- Skills -->
                    <div id="skills" class="bg-white rounded-xl shadow-lg p-8">
                        <div class="flex items-center justify-between mb-6">
                        ...
                        <!-- Popular Skills -->
                        <div class="mt-6">
                            <p class="text-sm font-medium text-gray-700 mb-3">Popular Skills in Aviation:</p>
                            <div class="flex flex-wrap gap-2">
                                <button type="button" class="skill-tag bg-gray-100 text-gray-700 px-3 py-1 rounded-full text-sm hover:bg-gray-200">
                                    Aviation Safety
                                </button>
                                <button type="button" class="skill-tag bg-gray-100 text-gray-700 px-3 py-1 rounded-full text-sm hover:bg-gray-200">
                    ...
                    <!-- Job Preferences -->
                    <div id="preferences" class="bg-white rounded-xl shadow-lg p-8">
                        <div class="flex items-center justify-between mb-6">
                    ...
                    <?php else: ?>
                    <!-- Company Information -->
                    <div id="company" class="bg-white rounded-xl shadow-lg p-8">
                        <div class="flex items-center justify-between mb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                                    ...
                                    <option value="aviation">Aviation Services</option>
                        ...
                        <div class="mt-8 pt-8 border-t">
                            ...
                            <div class="flex items-center">
                                <div class="w-32 h-32 bg-blue-100 rounded-lg flex items-center justify-center mr-6">
                    ...
                    <!-- Resume/CV -->
                    <div id="resume" class="bg-white rounded-xl shadow-lg p-8">
                        <div class="flex items-center justify-between mb-6">
                        ...
                        <div class="border-2 border-dashed border-gray-300 rounded-xl p-8 text-center">
                            ...
                            <label class="cursor-pointer bg-blue-600 text-white px-8 py-3 rounded-lg hover:bg-blue-700 font-medium inline-block">
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div class="flex items-end">
                                        <button type="button" class="bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 font-medium">
                                            Update Password
                                        </button>
                                    </div>
                                </div>
                            ...
                            <div class="pt-6 border-t">
                                ...
                                <div class="space-y-4">
                                    <label class="flex items-center justify-between">
                                        ...
                                        <input type="checkbox" class="relative h-6 w-11 rounded-full bg-gray-200 checked:bg-blue-600">
                                    </label>
                                    <label class="flex items-center justify-between">
                                        <div>
                                        ...
                                        <input type="checkbox" class="relative h-6 w-11 rounded-full bg-gray-200 checked:bg-blue-600" checked>
                                    </label>
                                    <label class="flex items-center justify-between">
                                        <div>
