            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        ...
                        <li><a href="<?php echo $baseUrl; ?>/job-search.php" class="text-gray-400 hover:text-white">Find Jobs</a></li>
                        <li><a href="<?php echo $baseUrl; ?>/about.php" class="text-gray-400 hover:text-white">About Us</a></li>
                        <li><a href="<?php echo $baseUrl; ?>/contact.php" class="text-gray-400 hover:text-white">Contact Us</a></li>
                        <li><a href="<?php echo $baseUrl; ?>/privacy.php" class="text-gray-400 hover:text-white">Privacy Policy</a></li>
                        <li><a href="<?php echo $baseUrl; ?>/terms.php" class="text-gray-400 hover:text-white">Terms of Service</a></li>
                    </ul>
                </div>
